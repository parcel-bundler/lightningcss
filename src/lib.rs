...
@font-feature-values "Inconsolata LGC" {
  ...
  fn test_color() {
    ...
    minify_test(
      ".foo { color: light-dark(#ffffff, rgb(255 255 255)) }",
      ".foo{color:#fff}",
    );
    minify_test(
      ".foo { color: light-dark(rgb(255 255 255 / 1), hsl(0deg 0% 100%))}",
      ".foo{color:#fff}",
    );
    ...
    minify_test(
      ".foo {color: light-dark(hsl(0 0% 100%), rgb(255 255 255))",
      ".foo{color:#fff}",
    );
    minify_test(
      ".foo { color: light-dark(aliceblue, aliceblue) }",
      ".foo{color:#f0f8ff}",
    );
    minify_test(
      ".foo { color: light-dark(rebeccapurple, rebeccapurple) }",
      ".foo{color:#639}",
    );
    minify_test(
